...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="{{url('/home')}}" class="nav-link" target="">Allez sur le site</a>
      </li>
      <li class="nav-item d-none d-sm-inline-block">
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
          ...
          <a href="{{url('admin/profile')}}" class="dropdown-item">
            <i class="fas fa-file mr-2"></i> Parametre
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <img src="{{asset('images/img/AdminLTELogo.png')}}" alt="Viendindin Logo" class="brand-image img-circle elevation-3"
           style="opacity: .8">
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="{{url('/admin/utilisateur')}}" class="nav-link">
              <i class="nav-icon fas fa-users"></i>
              <p>Liste des utilisateurs</p>
            </a>
          </li>
          <li class="nav-item has-treeview">
            <a href="{{url('/admin/films')}}" class="nav-link">
              <i class="nav-icon fas fa-copy"></i>
              <p>Films</p>
            </a>
          </li>
          <li class="nav-item has-treeview">
            <a href="{{url('/admin/serie')}}" class="nav-link">
              <i class="nav-icon fas fa-chart-pie"></i>
              <p>Series</p>
            </a>
          </li>
          <li class="nav-item has-treeview">
            <a href="{{url('/admin/producteur')}}" class="nav-link">
              <i class="nav-icon fas fa-tree"></i>
              <p>Producteurs</p>
            </a>
          </li>
          <li class="nav-item has-treeview">
            <a href="{{url('/admin/acteur')}}" class="nav-link">
          ...
          <li class="nav-item has-treeview">
            <a href="{{url('/admin/langue-audio')}}" class="nav-link">
              <i class="nav-icon fas fa-table"></i>
              <p>Langue Audio</p>
            </a>
          </li>
